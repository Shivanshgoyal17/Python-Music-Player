...
class View:
    def __init__(self, top=None):
        ...
        self.songName.configure(text='''Select a song''')
    ...
    def setup_player(self):
        try:
            ...
            if self.my_player.get_db_status():
                ...
                self.loadFavourite.config(command=self.load_song_from_favourites)
        ...
        self.top.title("MOUZIKA-Dance to the Rhythm of your Heart!")
    ...
    def close_window(self):
        ...
        if(result):
            ...
            messagebox.showinfo("Have  a Good Day!","Thankyou for using \"MOUZIKA\" ")
            self.top.destroy()
    ...
    def load_song_from_favourites(self):
        try:
            ...
            messagebox.showinfo("Success!!!", "List populated from the favourites!!!")
